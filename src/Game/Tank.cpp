...
Tank::Tank(std::shared_ptr<RenderEngine::AnimatedSprite> pSprite, const float velocity, const glm::vec2& position) : m_eOrientation(EOrientation::Top),
...
void Tank::setOrientatnion(const EOrientation eOrientation) {
